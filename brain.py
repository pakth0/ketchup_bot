...
class Brain:
    ...
    def _on_hotdog_detected(self, event):
        ...
        if self.fireable and abs(x - self.center_x) < self.hotdog_threshold_distance and abs(y - self.center_y) < self.hotdog_threshold_distance:
            print("hotdog is in dead zone, FIRE")
